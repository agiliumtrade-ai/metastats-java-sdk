...
There you will need to fill a form with these fields:
    ...
    - Summary: `Create a repository for Metastats Java SDK` _(or something like that)_
    ...
    - SCM url: [https://github.com/agiliumtrade-ai/metastats-java-sdk.git](https://github.com/agiliumtrade-ai/metastats-java-sdk.git)
